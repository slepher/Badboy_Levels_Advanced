...
levelsBox:SetScript("OnHide", function(frame)
	...
	if not n or n == "" then frame:SetText(BADBOY_LEVEL_ADVANCED or 1) print("|cFF33FF99BadBoy_Levels|r == "..(BADBOY_LEVEL_ADVANCED or 1)) return end
	if n < 1 then
		frame:SetText(BADBOY_LEVEL_ADVANCED or 1)
		print("|cFF33FF99BadBoy_Levels|r == "..(BADBOY_LEVEL_ADVANCED or 1))
	else
		BADBOY_LEVEL_ADVANCED = n
...
BadBoyLevelsConfigTitle:SetText("BadBoy_Levels r114-release") --wowace magic, replaced with tag version
